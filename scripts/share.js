          ...
          o = (function () {
            var t = function (t, r) {
              var e = t,
                ...
                k = function () {
                  for (
                    var t = u.getPatternPosition(e), r = 0;
                    r < t.length;
                    r += 1
                  )
                ...
                b = function (t, r) {
                  for (
                    var e = (n << 3) | r, a = u.getBCHTypeInfo(e), f = 0;
                    f < 15;
                    f += 1
                  ) {
                    var c = !t && 1 == ((a >> f) & 1);
                ...
                L = function (t, r, e) {
                  for (
                    var n = g.getRSBlocks(t, r), o = s(), i = 0;
                    i < e.length;
                    i += 1
                  ) {
                    var a = e[i];
              ...
              ((p.addData = function (t, r) {
                ...
                (p.make = function () {
                  if (e < 1) {
                    for (var t = 1; t < 40; t++) {
                      for (
                        var r = g.getRSBlocks(t, n), o = s(), i = 0;
                        i < w.length;
                        i++
                      ) {
                        var a = w[i];
