(() => {
        ...
        !(function () {
          ...
          function L(t, n, i, e, o, a, s) {
            ((this.v = t),
              ...
              (t = I((t = new j(this.a.c + ",serif", k(this.a))))),
              (this.g.a.style.cssText = t),
              (t = I((t = new j(this.a.c + ",sans-serif", k(this.a))))),
              (this.h.a.style.cssText = t),
              (t = I((t = new j("serif", k(this.a))))),
              (this.j.a.style.cssText = t),
              (t = I((t = new j("sans-serif", k(this.a))))),
          ...
          function $(t, n, i) {
            for (var e in W)
              if (W.hasOwnProperty(e) && n === t.f[W[e]] && i === t.f[W[e]])
                return !0;
            return !1;
          }
          function M(t) {
          ...
          function G(t, n, i, e, o) {
            var a = 0 == --t.h;
            (t.f || t.g) &&
              setTimeout(function () {
                var t = o || null,
                  r = e || {};
                if (0 === i.length && a) A(n.a);
                else {
                  ...
                  for (c = 0; c < i.length; c++) {
                    ...
                    if (
                      (u.g &&
                        p(u.f, [u.a.c("wf", d.c, k(d).toString(), "loading")]),
                      E(u, "fontloading", d),
                      (u = null),
                      null === U)
                    )
                      if (window.FontFace) {
                        ...
                        U = d ? 42 < parseInt(d[1], 10) : !g;
                      } else U = !1;
                    ((u = U
                      ? new O(s(n.g, n), s(n.h, n), n.c, h, n.s, l)
                      : new L(s(n.g, n), s(n.h, n), n.c, h, n.s, t, l)),
                      f.push(u));
                  }
          ...
          ((H.prototype.g = function (t) {
            ...
            (n.g &&
              p(
                n.f,
                [n.a.c("wf", t.c, k(t).toString(), "active")],
                [
                  n.a.c("wf", t.c, k(t).toString(), "loading"),
                  n.a.c("wf", t.c, k(t).toString(), "inactive"),
                ],
              ),
              E(n, "fontactive", t),
              (this.m = !0),
            ...
            (H.prototype.h = function (t) {
              var n = this.a;
              if (n.g) {
                var i = d(n.f, n.a.c("wf", t.c, k(t).toString(), "active")),
                  e = [],
                  o = [n.a.c("wf", t.c, k(t).toString(), "loading")];
                (i || e.push(n.a.c("wf", t.c, k(t).toString(), "inactive")),
                  p(n.f, e, o));
              }
              (E(n, "fontinactive", t), V(this));
            }),
            ...
            (R.prototype.load = function (t) {
              var n,
                ...
                s = new m();
              for (n = 0, i = e.length; n < i; n++) g(this.c, e[n], w(s));
              var r = [];
          ...
          var et = { Arimo: !0, Cousine: !0, Tinos: !0 };
          function ot(t, n) {
            ((this.c = t), (this.a = n));
          }
          function at(t, n) {
                    ...
                    for (
                      ...
                      if ((h = r[f]).match(/^[\w-]+$/))
                        if (null == (l = nt.exec(h.toLowerCase()))) h = "";
                          ...
                          if (
                            ((h = null == (h = l[2]) || "" == h ? "n" : tt[h]),
                            null == (l = l[1]) || "" == l)
                          )
                            l = "4";
                          else
                            var l = Z[l] || (isNaN(l) ? "4" : l.substr(0, 1));
                          h = [h, l].join("");
                        }
                      else h = "";
                      h && s.push(h);
  ...
  const i = (function i(e) {
    ...
    e = window.customFontName,
    o = window.customFontUrl;
  e &&
    o &&
    window.addEventListener("DOMContentLoaded", () => {
      i.load({
        custom: { families: [e], urls: [o] },
        loading: () => {
          console.log(`Loading custom font: ${o}`);
        },
        active: () => {
      ...
      const t = document.documentElement,
        n =
          e.split(":")[0] +
          ", " +
          getComputedStyle(t).getPropertyValue("--base-font-family");
      t.style.setProperty("--base-font-family", n);
    });
})();
//# sourceMappingURL=customFontLoader.js.map
